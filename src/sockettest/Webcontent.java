...
public class Webcontent implements RecordHandler {
	...
	public byte[] filterword(byte srtbyte[], String charset) throws Exception {
		File file = new File("D:\\phishing\\keywordtobefilted.txt");
	...
	public String getwritetxt(String s) throws IOException {
		String r = getname();
		File txt = new File("D:/phishing/" + r + ".txt");
		if (!txt.exists()) {
			txt.createNewFile();
		}
	...
	public String getwritehtml(String s, String charset, int sign)
			throws Exception {
		String r = getname();
		File html = new File("D:/phishing/" + r + ".html");
		if (!html.exists()) {
			html.createNewFile();
		}
	...
	public String getcharset(String s) throws IOException {
		...
		String c=getEncode(s);
//        int start =s.indexOf("charset"); 
//        int end =s.indexOf("\"",start);  
//        String charset=s.substring(start+8,end);  
//        System.out.println("charset "+charset);  
//			if (charset.contains("utf-8"))
//				return "utf-8";
//			else if (charset.contains("gbk"))
//				return "gbk";
//			else if (charset.contains("gb2312"))
//				return "gb2312";
		return c;
	}
